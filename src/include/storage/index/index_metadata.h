...
class IndexMetadata {
 public:
   ...
   */
  const std::vector<uint16_t> &GetCompactIntsOffsets() const { return compact_ints_offsets_; }
 ...
 private:
   ...
   */
  static std::vector<uint16_t> ComputeCompactIntsOffsets(const std::vector<uint16_t> &attr_sizes) {
    // exclusive scan
